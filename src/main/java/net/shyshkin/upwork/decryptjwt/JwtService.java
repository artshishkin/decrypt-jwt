...
public class JwtService {
    ...
    void init() {
        ...
        EncryptedJWT encryptedJWT = encrypt(publicKey);
        String jwtString = encryptedJWT.serialize();
        System.out.println(jwtString);

//        var decrypted = decrypt(encryptedJwt, privateKey);
        var decrypted = decrypt(jwtString, privateKey);
        ...
        try {
            JWTClaimsSet jwtClaimsSet = decrypted.getJWTClaimsSet();
...
//            decrypter.getJCAContext().setProvider(BouncyCastleProviderSingleton.getInstance());
    ...
    public EncryptedJWT encrypt(String publicKey) {
        Date now = new Date();
